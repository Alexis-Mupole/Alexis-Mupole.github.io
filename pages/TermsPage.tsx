...
const TermsPage: React.FC<TermsPageProps> = ({ onNavigate }) => {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-slate-900">
      <section className="pt-32 pb-16 bg-slate-50 dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <button
            onClick={() => onNavigate('home')}
            className="inline-flex items-center gap-2 text-slate-600 dark:text-slate-300 dark:text-slate-300 hover:text-blue-600 transition-colors mb-8 text-sm font-medium"
          >
            <ArrowLeft size={16} />
            {t.nav.home}
          </button>
          ...
          <p className="text-slate-500 dark:text-slate-400 text-sm">Last updated: June 2025</p>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">1. Services</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">2. Intellectual Property</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">3. Client Responsibilities</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">4. Payments & Fees</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">5. Confidentiality</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">6. Limitation of Liability</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">7. Third-Party Tools & Services</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">8. Termination</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">9. Changes to Terms</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">10. Governing Law</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">11. Contact</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
