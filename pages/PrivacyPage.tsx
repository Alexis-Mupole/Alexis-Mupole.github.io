      ...
      <section className="py-16 lg:py-20">
        <div className="max-w-4xl mx-auto px-6 lg:px-8">
          <div className="prose prose-slate max-w-none">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">1. Information I Collect</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">2. How I Use Your Information</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">3. Data Protection & Security</h2>
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">4. Data Sharing & Third Parties</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">5. Cookies</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">6. Your Rights</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-4">
            ...
            <h2 className="text-2xl font-bold text-slate-900 dark:text-white mt-12 mb-4">7. Contact</h2>
            <p className="text-slate-700 dark:text-slate-300 leading-relaxed mb-6">
